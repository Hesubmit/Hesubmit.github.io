...
mapboxgl.accessToken =
  "pk.eyJ1IjoiaGVzdWJtaXQiLCJhIjoiY2xyNmVpOWtpMmI1djJwdDNybTZqZGZ0ZCJ9.GW0MsXnXcZe-ulZawb6HHg";

// Define a map object by initialising a Map from Mapbox
const map = new mapboxgl.Map({
  container: "map",
  // Replace YOUR_STYLE_URL with your style URL.
  style: "mapbox://styles/hesubmit/clrgez53900gx01peaykqdch0",
  center: [-4.2518, 55.8642],
  zoom: 9
});
map.on("mousemove", (event) => {
  const dzone = map.queryRenderedFeatures(event.point, {
    layers: ["sg-simd-2020-glasgow-simd"]
  });
